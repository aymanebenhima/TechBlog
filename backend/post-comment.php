        ...
        <nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
            ...
            <ul class="navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown no-caret mr-3 dropdown-notifications">
                    ...
                    <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownMessages">
                        ...
                        <a class="dropdown-item dropdown-notifications-item" href="#!"
                            ...
                            <div class="dropdown-notifications-item-content">
                                <div class="dropdown-notifications-item-content-text">Lorem ipsum dolor sit amet, consectetur adipisicing.</div>
                ...
                <li class="nav-item dropdown no-caret mr-3 dropdown-user">
                    <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage" href="javascript:void(0);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="img-fluid" src="./assets/img/avatar.png"/></a>
                    <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up" aria-labelledby="navbarDropdownUserImage">
                        <h6 class="dropdown-header d-flex align-items-center">
                            <img class="dropdown-user-img" src="./assets/img/avatar.png" alt="Photo" />
                            <div class="dropdown-user-details">
                                <div class="dropdown-user-details-name">Aymane Benhima</div>
                                <div class="dropdown-user-details-email">aymanebenhima@gmail.com</div>
                            </div>
                        </h6>
        ...
        <div id="layoutSidenav">
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    ...
                    <div class="sidenav-footer">
                        <div class="sidenav-footer-content">
                            ...
                            <div class="sidenav-footer-title">Aymane Benhima</div>
                        </div>
                    </div>
            ...
            <div id="layoutSidenav_content">
                ...
                <footer class="footer mt-auto footer-light">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 small">Copyright &#xA9; Bloggy 2020</div>
