                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><a class="small" href="#"></a><a class="btn btn-primary btn-block" href="index.php">SIGN IN</a></div>
                                        </form>
                                    </div>
