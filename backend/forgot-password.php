                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0"><a class="small" href="login-basic.php">Return to login</a><a class="btn btn-primary" href="#">Reset Password</a></div>
                                        </form>
                                    </div>
